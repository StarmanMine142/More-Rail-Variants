...
import static de.pnku.mstv_mtv.init.MtvItemInit.more_redstone_torches;
...
public class MoreRailVariantRecipeGenerator extends FabricRecipeProvider {
    ...
    public Map<Item, Item> more_redstone_rail_torches(){
        ...
        for (int i = 0; i < min(more_redstone_torches.size(), more_activator_rail_items.size()); i++) {
            more_redstone_rail_torch_items.put(more_activator_rail_items.get(i), more_redstone_torches.get(i));
        }
            ...
            public void buildRecipes() {
                ...
                for (Item railItem : more_rail_items) {
                    ...
                    if (more_activator_rail_items.contains(railItem)) {
                        ...
                        this.shaped(RecipeCategory.TRANSPORTATION, railItem, 6)
                        ...
                        LOGGER.info(railItem + " -> Map: " + more_redstone_rail_torch_items.get(railItem) + " out of " + more_redstone_rail_torch_items);
                        ...
                        this.shaped(RecipeCategory.TRANSPORTATION, railItem, 6)
                                ...
                                .group("activator_rail")
                                .unlockedBy("has_rail", has(baseRailItemA))
                                .save(withConditions(recipeOutput, ResourceConditions.allModsLoaded("quad-mstv-mtv")), String.valueOf(RecipeBuilder.getDefaultRecipeId(railItem).withSuffix("_from_mstv_torch_variants")));
                    ...
                    if (more_simple_rail_items.contains(railItem)) {
                        this.shaped(RecipeCategory.TRANSPORTATION, railItem, 16)
                                .define('S', stickVariant)
                                .define('X', ConventionalItemTags.IRON_INGOTS)
                                .pattern("X X")
                                .pattern("XSX")
