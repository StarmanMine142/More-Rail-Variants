            ...
            public void buildRecipes() {
                ...
                for (Item railItem : more_rail_items) {
                    ...
                    if (more_activator_rail_items.contains(railItem)) {
                        ...
                        ShapedRecipeBuilder.shaped(BuiltInRegistries.ITEM, RecipeCategory.TRANSPORTATION, railItem, 6)
                    ...
                    if (more_simple_rail_items.contains(railItem)) {
                        ShapedRecipeBuilder.shaped(BuiltInRegistries.ITEM, RecipeCategory.TRANSPORTATION, railItem, 16)
                                .define('S', stickVariant)
                                .define('X', ConventionalItemTags.IRON_INGOTS)
                                .pattern("X X")
                                .pattern("XSX")
