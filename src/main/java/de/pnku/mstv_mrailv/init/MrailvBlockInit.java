...
public class MrailvBlockInit {
    ...
    public static final Block WARPED_RAIL = registerRailBlock("warped", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL).sound(SoundType.NETHER_WOOD)));
    ...
    public static final Block CRIMSON_RAIL = registerRailBlock("crimson", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL).sound(SoundType.NETHER_WOOD)));
    ...
    public static final Block BAMBOO_RAIL = registerRailBlock("bamboo", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL)));
    public static final Item BAMBOO_RAIL_I = registerRailItem("bamboo", new BlockItem(BAMBOO_RAIL, new Item.Properties()));

    public static final Block CHERRY_RAIL = registerRailBlock("cherry", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL)));
    public static final Item CHERRY_RAIL_I = registerRailItem("cherry", new BlockItem(CHERRY_RAIL, new Item.Properties()));

    public static final Block MANGROVE_RAIL = registerRailBlock("mangrove", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL)));
    public static final Item MANGROVE_RAIL_I = registerRailItem("mangrove", new BlockItem(MANGROVE_RAIL, new Item.Properties()));

    public static final Block DARK_OAK_RAIL = registerRailBlock("dark_oak", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL)));
    public static final Item DARK_OAK_RAIL_I = registerRailItem("dark_oak", new BlockItem(DARK_OAK_RAIL, new Item.Properties()));

    public static final Block ACACIA_RAIL = registerRailBlock("acacia", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL)));
    public static final Item ACACIA_RAIL_I = registerRailItem("acacia", new BlockItem(ACACIA_RAIL, new Item.Properties()));

    public static final Block JUNGLE_RAIL = registerRailBlock("jungle", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL)));
    public static final Item JUNGLE_RAIL_I = registerRailItem("jungle", new BlockItem(JUNGLE_RAIL, new Item.Properties()));

    public static final Block BIRCH_RAIL = registerRailBlock("birch", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL)));
    public static final Item BIRCH_RAIL_I = registerRailItem("birch", new BlockItem(BIRCH_RAIL, new Item.Properties()));

    public static final Block SPRUCE_RAIL = registerRailBlock("spruce", new RailBlock(BlockBehaviour.Properties.copy(Blocks.RAIL)));
    ...
    public static final Block WARPED_ACTIVATOR_RAIL = registerRailBlock("warped", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL).sound(SoundType.NETHER_WOOD)), "activator");
    ...
    public static final Block CRIMSON_ACTIVATOR_RAIL = registerRailBlock("crimson", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL).sound(SoundType.NETHER_WOOD)), "activator");
    ...
    public static final Block BAMBOO_ACTIVATOR_RAIL = registerRailBlock("bamboo", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL)), "activator");
    ...
    public static final Block CHERRY_ACTIVATOR_RAIL = registerRailBlock("cherry", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL)), "activator");
    ...
    public static final Block MANGROVE_ACTIVATOR_RAIL = registerRailBlock("mangrove", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL)), "activator");
    ...
    public static final Block DARK_OAK_ACTIVATOR_RAIL = registerRailBlock("dark_oak", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL)), "activator");
    ...
    public static final Block ACACIA_ACTIVATOR_RAIL = registerRailBlock("acacia", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL)), "activator");
    ...
    public static final Block JUNGLE_ACTIVATOR_RAIL = registerRailBlock("jungle", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL)), "activator");
    ...
    public static final Block BIRCH_ACTIVATOR_RAIL = registerRailBlock("birch", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL)), "activator");
    ...
    public static final Block SPRUCE_ACTIVATOR_RAIL = registerRailBlock("spruce", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.ACTIVATOR_RAIL)), "activator");
    ...
    public static final Block WARPED_DETECTOR_RAIL = registerRailBlock("warped", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL).sound(SoundType.NETHER_WOOD)), "detector");
    ...
    public static final Block CRIMSON_DETECTOR_RAIL = registerRailBlock("crimson", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL).sound(SoundType.NETHER_WOOD)), "detector");
    ...
    public static final Block BAMBOO_DETECTOR_RAIL = registerRailBlock("bamboo", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL)), "detector");
    ...
    public static final Block CHERRY_DETECTOR_RAIL = registerRailBlock("cherry", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL)), "detector");
    ...
    public static final Block MANGROVE_DETECTOR_RAIL = registerRailBlock("mangrove", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL)), "detector");
    ...
    public static final Block DARK_OAK_DETECTOR_RAIL = registerRailBlock("dark_oak", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL)), "detector");
    ...
    public static final Block ACACIA_DETECTOR_RAIL = registerRailBlock("acacia", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL)), "detector");
    ...
    public static final Block JUNGLE_DETECTOR_RAIL = registerRailBlock("jungle", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL)), "detector");
    ...
    public static final Block BIRCH_DETECTOR_RAIL = registerRailBlock("birch", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL)), "detector");
    ...
    public static final Block SPRUCE_DETECTOR_RAIL = registerRailBlock("spruce", new DetectorRailBlock(BlockBehaviour.Properties.copy(Blocks.DETECTOR_RAIL)), "detector");
    ...
    public static final Block WARPED_POWERED_RAIL = registerRailBlock("warped", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL).sound(SoundType.NETHER_WOOD)), "powered");
    ...
    public static final Block CRIMSON_POWERED_RAIL = registerRailBlock("crimson", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL).sound(SoundType.NETHER_WOOD)), "powered");
    ...
    public static final Block BAMBOO_POWERED_RAIL = registerRailBlock("bamboo", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)), "powered");
    ...
    public static final Block CHERRY_POWERED_RAIL = registerRailBlock("cherry", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)), "powered");
    ...
    public static final Block MANGROVE_POWERED_RAIL = registerRailBlock("mangrove", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)), "powered");
    ...
    public static final Block DARK_OAK_POWERED_RAIL = registerRailBlock("dark_oak", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)), "powered");
    ...
    public static final Block ACACIA_POWERED_RAIL = registerRailBlock("acacia", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)), "powered");
    ...
    public static final Block JUNGLE_POWERED_RAIL = registerRailBlock("jungle", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)), "powered");
    ...
    public static final Block BIRCH_POWERED_RAIL = registerRailBlock("birch", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)), "powered");
    ...
    public static final Block SPRUCE_POWERED_RAIL = registerRailBlock("spruce", new PoweredRailBlock(BlockBehaviour.Properties.copy(Blocks.POWERED_RAIL)), "powered");
